...
const getAttendanceByDate = async (req,res)=>{
    ...
    ApiResponse.created(res,"Attendence fetched", attendenceRes);
};
const getAttendanceByStudent = async (req,res)=>{

    const attendenceRes = await attendenceService.getAttendanceByStudent(req.params.id,req.user.classAssigned);
    ApiResponse.created(res,"Student Attendence fetched", attendenceRes);
};
